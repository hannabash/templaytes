...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:ms="urn:microsoft-performance" exclude-result-prefixes="msxsl" version="1.0">
	...
	<xsl:variable name="images">
		...
		<!-- root cause states -->
		<String id="fixed">Исправлено</String>
		<String id="notfixed">Не исправлено</String>
		<String id="detected">Обнаружено</String>
		<!-- details -->
		<String id="info">Информационное</String>
		<String id="warning">Предупреждение</String>
		<String id="error">Ошибка</String>
		<!-- expand and print buttons -->
		<String id="expand">Развернуть</String>
		<String id="print">Печать</String>
	</xsl:variable>
...
function key_folder(d, state)
{
  if (window.event.keyCode == 13) {
    ...
    event.returnValue = false;
						...
						<div class="page">
							<xsl:variable name="strings">
								<String id="Found">Обнаруженные проблемы</String>
								<String id="Checked">Проверенные потенциальные проблемы</String>
								<String id="Publisher">Сведения об издателе</String>
								<String id="Detection">Сведения об обнаружении</String>
								<String id="Scripts">Сценарии</String>
							</xsl:variable>
	...
	<xsl:template name="RootCauseStatus">
		<xsl:variable name="strings">
			<String id="Fixed">Исправлено</String>
			<String id="Not Detected">Элемент отсутствует</String>
			<String id="Not Fixed">Не исправлено</String>
			<String id="Detected">Обнаружено</String>
		</xsl:variable>
		<div>
			<xsl:if test="Data[@id='Status'] = 'Not Detected'">
	...
	<xsl:template name="RootCauseEmpty">
		<xsl:variable name="strings">
			<String id="Empty">Неполадок не обнаружено</String>
		</xsl:variable>
	...
	<xsl:template name="ResolutionStatus">
		<xsl:variable name="strings">
			<String id="Not Run">Не выполнено</String>
			<String id="Succeeded">Завершено</String>
			<String id="Failed">Произошла ошибка</String>
			<String id="Informational">Информация</String>
			<String id="Status">Состояние</String>
		</xsl:variable>
		<div class="italic">
			<xsl:call-template name="label">
				<xsl:with-param name="strings" select="$strings"/>
	...
	<xsl:template name="ScriptStatus">
		<xsl:variable name="strings">
			<String id="Succeeded">Успешно</String>
			<String id="Failed">Сбой</String>
		</xsl:variable>
		<xsl:choose>
	...
	<xsl:template name="FunctionStatus">
		<xsl:variable name="strings">
			<String id="Succeeded">Успешное выполнение</String>
			<String id="Failed">Сбой</String>
		</xsl:variable>
		<xsl:choose>
	...
	<xsl:template match="InputArguments[Data]|OutputArguments[Data[@id !='Result']]">
		<xsl:variable name="strings">
			<String id="InputArguments">Входные аргументы</String>
			<String id="OutputArguments">Выходные аргументы</String>
		</xsl:variable>
	...
	<xsl:template match="Object[@Type='System.Diagnostics.Eventing.Reader.EventLogRecord']">
		<xsl:variable name="strings">
			<String id="LevelDisplayName">Уровень</String>
			<String id="LogName">Журнал</String>
			<String id="TimeCreated">Дата</String>
			<String id="Message">Сообщение</String>
		</xsl:variable>
	...
	<xsl:template match="Data[@id='RunningTime']">
		<xsl:variable name="strings">
			<String id="millisecond">мс</String>
		</xsl:variable>
		<tr>
			<th><xsl:value-of select="@name"/>:</th>
			<td>
	...
	<xsl:template match="ComputerInformation">
		<xsl:variable name="strings">
			<String id="Computer">Имя компьютера</String>
			<String id="Collection">Сведения о коллекции</String>
		</xsl:variable>
